...
public class MaxMinMiddle {
    public static void main(String[] args) {
        ...
        System.out.println("Max is = " + MathHelper.maxOfThree(r1, r2, r3));
        System.out.println("Min is = " + MathHelper.minOfThree(r1, r2, r3));
        System.out.println("Middle is = " + MathHelper.middleOfThree(r1, r2, r3));
